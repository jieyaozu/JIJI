package com.yaozu.object.httpmanager;

import android.content.Context;
import android.text.TextUtils;

import com.google.gson.Gson;
import com.yaozu.object.utils.Logger;
import com.yaozu.object.volley.RequestQueue;
import com.yaozu.object.volley.Response;
import com.yaozu.object.volley.VolleyError;
import com.yaozu.object.volley.Request;
import com.yaozu.object.volley.toolbox.StringRequest;
import com.yaozu.object.volley.toolbox.Volley;
...
public class RequestManager {
	...
	public void getRequest(Context context, String url, ParamList params,
		...
		http_Request(context, url, params, mClass, code, tag,
				Request.Method.GET, onResponseListener);
	}
	...
	public void postRequest(Context context, String url, ParamList params,
							...
							OnResponseListener onResponseListener) {
		http_Request(context, url, params, mClass, code, tag,
				Request.Method.POST, onResponseListener);
	}
		...
		StringRequest stringRequest = new StringRequest(method, url,
			...
			protected Map<String, String> getParams() {
				...
				for (int i = 0; i < params.size(); i++) {
					ParamList.Parameter param = params.get(i);
