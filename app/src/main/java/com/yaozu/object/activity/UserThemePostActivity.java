...
public class UserThemePostActivity extends BaseActivity {
    public static String TAG = "UserThemePostActivity";
    ...
    protected void settingActionBar(ActionBar actionBar) {
        actionBar.setTitle(username + "发的贴子");
    ...
    class ListThemeAdapter extends RecyclerView.Adapter<ThemeViewHolder> {
        ...
        public ThemeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ThemeViewHolder viewHolder = new ThemeViewHolder(LayoutInflater.from(UserThemePostActivity.this).inflate(R.layout.item_listview_theme, parent, false));
            return viewHolder;
        }
        ...
        public void onBindViewHolder(ThemeViewHolder holder, int position) {
            ...
            holder.tvContent.setText(getNoImageContent(post.getContent()));
            ...
            holder.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    IntentUtil.toPostDetailActivity(UserThemePostActivity.this, post);
                }
            });
        }
    ...
    private class NoScrollGridViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                view = View.inflate(UserThemePostActivity.this, R.layout.item_nogridview, null);
            }
